...
X_train = X_train.reshape(3,2).astype('float32')
...
y_train = y_train.reshape(1,3).astype('int')
y_train = y_train[ 0 ]
#
...
X_test = X_test.reshape(3,2).astype('float32')
...
y_test = y_test.reshape(1,3).astype('int')
y_test = y_test[ 0 ]
